...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var sum_ans = sum(a, sum(b,c)[0])[0];
  var prod_ans = multiply(a, multiply(b, c)[0])[0];

  var sum_str = a+" and "+b+" and "+c+" sum to "+sum_ans+".";
  var prod_str = "The product of "+a+" and "+b+" and "+c+" is "+prod_ans+"."

  return [sum_ans, prod_ans, sum_str, prod_str];
}
